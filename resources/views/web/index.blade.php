...
<div class="container mt-3">
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6  d-flex justify-content-center mt-4 mb-4">
            <a href="/category/{{ $category->slug }}" class="text-decoration-none">
                <div class="text-center">
                    <div class="card border-0 shadow-lg" style="border-radius: 50%; width: 180px; height: 180px; overflow: hidden;">
